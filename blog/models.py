...
class PostQuerySet(models.QuerySet):
    ...
    def fetch_with_comments_count(self):
        """ При использовании одного annotate() сложность запроса равна O^1,
        но уже при 2-х annotate() в запросе, она возрастает до O^2, именно
        поэтому в запросе annotate() можно использовать только один раз,
        никак не два или более. Подобная функция необходима, чтобы избежать
        потерь времени и ресурсов при использовании 2-х annotate().
        """
